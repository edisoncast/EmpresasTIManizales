...
|---|---|---|---|
| Empresas | [Base de datos de la Cámara de Comercio de Manizales por Caldas](https://ccmpc.org.co/basededatos/) y fuentes públicas específicas por empresa. | Registros con actividades CIIU relacionadas con software, servicios TI, infraestructura, conectividad, datos o ciberseguridad; forma jurídica, municipio y fechas registrales disponibles. | La URL es un portal de consulta general, no un permalink por registro. Una matrícula o actividad declarada no prueba por sí sola operación comercial actual ni una oferta tecnológica identificable. Los registros “En liquidación” se muestran como posiblemente inactivos. |
